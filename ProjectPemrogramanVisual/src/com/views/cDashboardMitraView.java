...
public class cDashboardMitraView extends cDashboardApp {
  ...
  private cComboBox pilihMenuOrderBahan = new cComboBox(
      new String[] { "Coffe", "Telur", "Beras", "Tepung", "Mie", "Gula", "Garem", "Penyedap", "Keju", "Saos", "Sawi" },
      190, 210, 300,
      30);
  ...
  private cComboBox pilihPTOrderBahan = new cComboBox(
      new String[] { "PT SAWI", "PT COFFE", "PT CABE", "PT KENCANA", "PT AMBATUKAM", "PT AMOUNG US", "PT BERAS" },
      190, 302,
      300,
      30);
  ...
  private cComboBox pilihDataLaporan = new cComboBox(
      new String[] { "Data Customer", "Data Karyawan", "Data Transaksi", "Data Order Online" }, 150, 23, 200,
      30);
  ...
  private cButton btnCetakReportTransaksi = new cButton("Cetak",600, 95, 150, 30, 20);

  // Component Data Report Meja
  private cButton btnCetakReportTransaksiOnline = new cButton("Cetak", 600, 95, 150, 30, 20);
  ...
  private void initsMenuMakanan() {
    ...
    tblMenuMakanan = new cTable(Model.getAllMenuMakanan(idMitra));
  ...
  private void initsMenuCoffe() {
    ...
    tblMenuCoffe = new cTable(Model.getAllMenuCoffe(idMitra));
  ...
  private void initsMenuNonCoffe() {
    ...
    tblMenuNonCoffe = new cTable(Model.getAllMenuNonCoffe(idMitra));
      ...
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        if (txtNamaUbahMakanan.getText().trim().isEmpty()
          ...
          if (Model.ubahMenuMakanan(idMenu, idMitra, namaMenu, jumlahMakanan, hargaMakanan,
              deskripsiMakanan)) {
            // kalau berhasil
            JOptionPane.showMessageDialog(cDashboardMitraView.this, "Menu Berhasil Diubah",
            ...
            JOptionPane.showMessageDialog(cDashboardMitraView.this, "Menu Gagal Diubah!", "Gagal",
                JOptionPane.ERROR_MESSAGE);
          }
        }
      }
  ...
  private void initsDataPromo() {
    ...
    tblDataPromo = new cTable(Model.getAllPromo(idMitra));
    ...
    btnHapusDataPromo.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        ...
        if (selectedIndex != -1) {
          ...
          Object[] options = { "IYA", "BATAL" };
          int konfirmasi = JOptionPane.showOptionDialog(null, "Yakin ingin menghapus data Promo!",
              "Konfirmasi Hapus Data Promo", JOptionPane.DEFAULT_OPTION, JOptionPane.QUESTION_MESSAGE, null, options,
              options[0]);

          if (konfirmasi == 0) {
            boolean isDeleted = Model.hapusDataPromo(idPromo);
            if (isDeleted) {
              JOptionPane.showMessageDialog(cDashboardMitraView.this,
  ...
  private void initsDataMeja() {
    ...
    tblDataMeja = new cTable(Model.getAllMeja(idMitra));
  ...
  private void initsKaryawanVerified() {
    ...
    tblDataKaryawan = new cTable(Model.getAllKaryawanVerified(idMitra));
  ...
  private void initsKaryawanTerverifikasi() {
    ...
    tblDataTerverifikasi = new cTable(Model.getAllKaryawantTerverifikasi(idMitra));
  ...
  private void initsDataTransaksi() {
    ...
    txtCariTransaksi.addActionListener(new java.awt.event.ActionListener() {
      @Override
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        String keyword = txtCariTransaksi.getText();

        tblDataTransaksi.setModel(Model.getCariTransaksiDiproses(keyword));
        ...
        tblDataTransaksi.getColumnModel().getColumn(3).setMinWidth(200);
        tblDataTransaksi.getColumnModel().getColumn(3).setMaxWidth(200);
        tblDataTransaksi.getColumnModel().getColumn(3).setWidth(200);
    ...
    tblDataTransaksi = new cTable(Model.getAllTransaksiDiproses(idMitra));
  ...
  private void initsProsesOrderOffline() {
    ...
    txtCariProsesOrderOffline.addActionListener(new java.awt.event.ActionListener() {
      @Override
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        String keyword = txtCariProsesOrderOffline.getText();

        tblDataProsesOrderOffline.setModel(Model.getCariTransaksiDiproses(keyword));
        ...
        tblDataProsesOrderOffline.getColumnModel().getColumn(3).setMinWidth(200);
        tblDataProsesOrderOffline.getColumnModel().getColumn(3).setMaxWidth(200);
        tblDataProsesOrderOffline.getColumnModel().getColumn(3).setWidth(200);
    ...
    tblDataProsesOrderOffline = new cTable(Model.getAllTransaksiDiproses(idMitra));
  ...
  private void initsProsesOrderOnline() {
    ...
    btnProsesOrderOnline.addActionListener(new java.awt.event.ActionListener() {
      @Override
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        int selectedIndex = tblDataProsesOrderOnline.getSelectedRow();

        if (selectedIndex != -1) {
          // kalo ada yang dipilih
          String idString = tblDataProsesOrderOnline.getValueAt(selectedIndex, 0).toString();
          int idTransaksi = Integer.parseInt(idString.replaceAll("[^0-9]", ""));

          if (Model.mitraProsesTransaksiOnline(idTransaksi)) {
            // kalo berhasil
            JOptionPane.showMessageDialog(cDashboardMitraView.this, "Proses Transaksi berhasil.", "Berhasil",
                JOptionPane.INFORMATION_MESSAGE);
            initsProsesOrderOnline();
    ...
    btnDetailProsesOrderOnline.addActionListener(new java.awt.event.ActionListener() {
      @Override
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        int selectedIndex = tblDataProsesOrderOnline.getSelectedRow();
    ...
    tblDataProsesOrderOnline = new cTable(Model.getAllOnlineAdminDiproses());

    tblDataProsesOrderOnline.getColumnModel().getColumn(0).setMinWidth(80);
    tblDataProsesOrderOnline.getColumnModel().getColumn(0).setMaxWidth(80);
    tblDataProsesOrderOnline.getColumnModel().getColumn(0).setWidth(80);

    tblDataProsesOrderOnline.getColumnModel().getColumn(1).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(1).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(1).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(2).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(2).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(2).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(5).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(5).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(5).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(6).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(6).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(6).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(7).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(7).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(7).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(8).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(8).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(8).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(9).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(9).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(9).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(10).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(10).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(10).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(11).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(11).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(11).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(12).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(12).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(12).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(13).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(13).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(13).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(14).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(14).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(14).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(15).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(15).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(15).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(16).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(16).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(16).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(17).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(17).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(17).setWidth(0);

    tblDataProsesOrderOnline.getColumnModel().getColumn(18).setMinWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(18).setMaxWidth(0);
    tblDataProsesOrderOnline.getColumnModel().getColumn(18).setWidth(0);

    spDataProsesOrderOnline = new cScrollPane(tblDataProsesOrderOnline, 0, 150, 1100, 400);

    labelPilihProsesOrderOnline.setForeground(cColor.WHITE);

    TitledBorder titledBorder = new TitledBorder(new LineBorder(cColor.BLACK), "Cari");
    titledBorder.setTitleFont(cFonts.CARI_FONT);

    txtCariProsesOrderOnline.setBorder(titledBorder);
    txtCariProsesOrderOnline.setSize(300, 45);

    content.add(btnProsesOrderOnline);
    content.add(btnDetailProsesOrderOnline);

    content.add(spDataProsesOrderOnline);
    content.add(labelPilihProsesOrderOnline);
    content.add(txtCariProsesOrderOnline);
    content.add(panelHeaderProsesOrderOnline);
  ...
  private void initsOrderBahan() {
    ...
    txtCariOrderBahan.addActionListener(new java.awt.event.ActionListener() {
      @Override
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        String keyword = txtCariOrderBahan.getText();

        tblOrderBahan.setModel(Model.getCariOrderBahanDiproses(keyword));
    ...
    tblOrderBahan = new cTable(Model.getAllOrderBahanMitraDiproses(idMitra));
    ...
    pilihMenuOrderUbahBahan.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        if (pilihMenuOrderUbahBahan.getSelectedItem().equals("Coffe")) {
          hargaBahan = 15000;
          String UbahBahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderUbahBahan.setText(UbahBahanHarga);
          ...
          String UbahBahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderUbahBahan.setText(UbahBahanHarga);
        } else if (pilihMenuOrderUbahBahan.getSelectedItem().equals("Tepung")) {
          hargaBahan = 20000;
          String UbahBahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderUbahBahan.setText(UbahBahanHarga);
        } else if (pilihMenuOrderUbahBahan.getSelectedItem().equals("Mie")) {
          hargaBahan = 25000;
          String UbahBahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderUbahBahan.setText(UbahBahanHarga);
        } else if (pilihMenuOrderUbahBahan.getSelectedItem().equals("Gula")) {
          hargaBahan = 16000;
          String UbahBahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderUbahBahan.setText(UbahBahanHarga);
        } else if (pilihMenuOrderUbahBahan.getSelectedItem().equals("Garem")) {
          hargaBahan = 13000;
          String UbahBahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderUbahBahan.setText(UbahBahanHarga);
        } else if (pilihMenuOrderUbahBahan.getSelectedItem().equals("Penyedap")) {
          hargaBahan = 14000;
          String UbahBahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderUbahBahan.setText(UbahBahanHarga);
        } else if (pilihMenuOrderUbahBahan.getSelectedItem().equals("Keju")) {
          hargaBahan = 13500;
          String UbahBahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderUbahBahan.setText(UbahBahanHarga);
        } else if (pilihMenuOrderUbahBahan.getSelectedItem().equals("Saos")) {
          hargaBahan = 5000;
          String UbahBahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderUbahBahan.setText(UbahBahanHarga);
        } else {
    ...
    btnSimpanOrderUbahBahan.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        if (txtJumlahOrderUbahBahan.getText().trim().isEmpty()
          ...
          String PembayaranOrder = "====================================================\n"
              + "Data Order Bahan" + "\n"
              + "====================================================\n"
              + String.format("%-40s: %s", "Jumlah bahan", txtJumlahOrderUbahBahan.getText()) + "\n"
              + String.format("%-40s: %s", "Jenis Bahan", pilihMenuOrderUbahBahan.getSelectedItem()) + "\n"
              + String.format("%-40s: %s", "Nama PT", pilihPTOrderUbahBahan.getSelectedItem()) + "\n"
              + String.format("%-40s: %s", "Deskripsi Bahan", txtDeskripsiOrderUbahBahan.getText()) + "\n"
              + String.format("%-40s: %s", "Harga Bahan", txtHargaOrderUbahBahan.getText()) + "\n"
              + "====================================================\n"
              + String.format("%-40s: %s", "Harga Total", txtHargaTotalUbahBahan.getText()) + "\n"
              + "====================================================\n"
              + "Masukan Uang"
              + "====================================================\n";
    ...
    pilihMenuOrderBahan.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        if (pilihMenuOrderBahan.getSelectedItem().equals("Coffe")) {
          ...
          String bahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderBahan.setText(bahanHarga);
        } else if (pilihMenuOrderBahan.getSelectedItem().equals("Tepung")) {
          hargaBahan = 20000;
          String bahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderBahan.setText(bahanHarga);
        } else if (pilihMenuOrderBahan.getSelectedItem().equals("Mie")) {
          hargaBahan = 25000;
          String bahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderBahan.setText(bahanHarga);
        } else if (pilihMenuOrderBahan.getSelectedItem().equals("Gula")) {
          hargaBahan = 16000;
          String bahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderBahan.setText(bahanHarga);
        } else if (pilihMenuOrderBahan.getSelectedItem().equals("Garem")) {
          hargaBahan = 13000;
          String bahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderBahan.setText(bahanHarga);
        } else if (pilihMenuOrderBahan.getSelectedItem().equals("Penyedap")) {
          hargaBahan = 14000;
          String bahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderBahan.setText(bahanHarga);
        } else if (pilihMenuOrderBahan.getSelectedItem().equals("Keju")) {
          hargaBahan = 13500;
          String bahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderBahan.setText(bahanHarga);
        } else if (pilihMenuOrderBahan.getSelectedItem().equals("Saos")) {
          hargaBahan = 5000;
          String bahanHarga = Integer.toString(hargaBahan);
          txtHargaOrderBahan.setText(bahanHarga);
        } else {
      ...
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        if (txtJumlahOrderBahan.getText().trim().isEmpty()
          ...
          String PembayaranOrder = "====================================================\n"
              + "Data Order Bahan" + "\n"
              + "====================================================\n"
              + String.format("%-40s: %s", "Jumlah bahan", txtJumlahOrderBahan.getText()) + "\n"
              + String.format("%-40s: %s", "Jenis Bahan", pilihMenuOrderBahan.getSelectedItem()) + "\n"
              + String.format("%-40s: %s", "Nama PT", pilihPTOrderBahan.getSelectedItem()) + "\n"
              + String.format("%-40s: %s", "Deskripsi Bahan", txtDeskripsiOrderBahan.getText()) + "\n"
              + String.format("%-40s: %s", "Harga Bahan", txtHargaOrderBahan.getText()) + "\n"
              + "====================================================\n"
              + String.format("%-40s: %s", "Harga Total", txtHargaTotalOrderBahan.getText()) + "\n"
              + "====================================================\n"
              + "Masukan Uang";
  ...
  private void initsDataHistoryBahan() {
    ...
    tblHistoryBahan = new cTable(Model.getAllOrderBahanMitraSelesai(idMitra));
  ...
  private void initsDataHistoryOrderOffline() {
    ...
    tblDataHistoryTransaksi = new cTable(Model.getAllTransaksiSelesai(idMitra));
  ...
  private void initsDataReport() {
    ...
    pilihDataLaporan.addActionListener(new java.awt.event.ActionListener() {
      ...
      public void actionPerformed(java.awt.event.ActionEvent ae) {
        ...
        } else if (selectedItem.equals("Data Transaksi")) {
          initsDataReportTransaksi();
        } else if (selectedItem.equals("Data Order Online")) {
          initsDataReportTransaksiOnline();
        }
      }
    });
  ...
  private void initsDataReportTransaksi() {
    resetSidebar();
    menuReport.setBackground(cColor.GREEN);
    menuReport.setForeground(cColor.WHITE);
    menuReport.setSidebarAktif();
    refreshContent();
    menuTitle.setText("Data Laporan Transaksi");

    content.add(pilihDataLaporan);
    content.add(labelDataLaporan);
    content.add(btnCetakReportTransaksi);

    btnCetakReportTransaksi.addActionListener(new java.awt.event.ActionListener() {
      @Override
      public void actionPerformed(java.awt.event.ActionEvent ae) {
  ...
  private void initsDataReportTransaksiOnline() {
    resetSidebar();
    menuReport.setBackground(cColor.GREEN);
    menuReport.setForeground(cColor.WHITE);
    menuReport.setSidebarAktif();
    refreshContent();
    menuTitle.setText("Data Laporan Transaksi Online");

    content.add(pilihDataLaporan);
    content.add(labelDataLaporan);
    content.add(btnCetakReportTransaksiOnline);

    btnCetakReportTransaksiOnline.addActionListener(new java.awt.event.ActionListener() {
      @Override
      public void actionPerformed(java.awt.event.ActionEvent ae) {
